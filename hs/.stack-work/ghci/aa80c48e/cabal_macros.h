...
/* package hs-simple-0.1.0.0 */
#ifndef VERSION_hs_simple
#define VERSION_hs_simple "0.1.0.0"
#endif /* VERSION_hs_simple */
#ifndef MIN_VERSION_hs_simple
#define MIN_VERSION_hs_simple(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hs_simple */
...
#define CURRENT_COMPONENT_ID "hs-simple-0.1.0.0-5C0B3BMzqMJ7nfRmWSWnKE-hs-simple"
