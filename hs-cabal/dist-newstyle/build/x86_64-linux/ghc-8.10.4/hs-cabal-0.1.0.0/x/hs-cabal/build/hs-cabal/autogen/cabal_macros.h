...
/* package hs-cabal-0.1.0.0 */
#ifndef VERSION_hs_cabal
#define VERSION_hs_cabal "0.1.0.0"
#endif /* VERSION_hs_cabal */
#ifndef MIN_VERSION_hs_cabal
#define MIN_VERSION_hs_cabal(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_hs_cabal */
...
#define CURRENT_COMPONENT_ID "hs-cabal-0.1.0.0-inplace-hs-cabal"
